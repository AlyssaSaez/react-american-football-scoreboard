    ...
    <div className="container">
      <section className="scoreboard">
        <div className="upperBtns">
          <button id="startBtn" className={`button button-primary button-primary-${isActive ? 'active' : 'inactive'}`} onClick={toggle}>
            {isActive ? 'Pause' : 'Start'}
          </button>
          <button id="resetBtn" className="button" onClick={reset}>
            Reset
        </button>
        </div>
        <div className="topRow">
          ...
          <div className="away">
            <h2 className="away__name">Crimson</h2>
